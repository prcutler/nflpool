...
class PicksController(BaseController):
    ...
    def submit_player_picks(self):
        ...
        if not self.logged_in_user_id:
            ...
            if user_query is None:
                ...
                # Get the user ID
                user_name = self.logged_in_user_id
    ...
    # Try a new way of doing Player Picks (v2)
    @pyramid_handlers.action(renderer='templates/picks/submit_picksv2.pt',
                             request_method='GET',
                             name='submit_picks2')
    def get_playerpicksv2(self):
    ...
    @pyramid_handlers.action(renderer='templates/picks/submit_picksv2.pt',
                             request_method='POST',
                             name='submit_picks2')
    def submit_player_picks_pos2t(self):
        vm = PlayerPicksViewModel()
        vm.from_dict(self.request.POST)
