...
class PlayerPicksService:
    ...
    def get_player_picks(
        cls,
        afc_east_winner_pick: int,
        afc_east_second: int,
        afc_east_last: int,
        afc_north_winner_pick: int,
        afc_north_second: int,
        afc_north_last: int,
        afc_south_winner_pick: int,
        afc_south_second: int,
        afc_south_last: int,
        afc_west_winner_pick: int,
        afc_west_second: int,
        afc_west_last: int,
        nfc_east_winner_pick: int,
        nfc_east_second: int,
        nfc_east_last: int,
        nfc_north_winner_pick: int,
        nfc_north_second: int,
        nfc_north_last: int,
        nfc_south_winner_pick: int,
        nfc_south_second: int,
        nfc_south_last: int,
        nfc_west_winner_pick: int,
        nfc_west_second: int,
        nfc_west_last: int,
        afc_qb_pick: int,
        nfc_qb_pick: int,
        ...
        afc_int_pick: int,
        nfc_int_pick: int,
        afc_wildcard1_pick: int,
        afc_wildcard2_pick: int,
        nfc_wildcard1_pick: int,
        nfc_wildcard2_pick: int,
        afc_pf_pick: int,
        nfc_pf_pick: int,
        ...
        # Add AFC team picks
        afc_east_winner_db = PlayerPicks(
            user_id=user_id,
            season=season,
            date_submitted=dt,
            conf_id=0,
            division_id=1,
            rank=1,
            team_id=afc_east_winner_pick,
            pick_type=1,
        )
        session.add(afc_east_winner_db)
        afc_east_second_db = PlayerPicks(
            user_id=user_id,
            season=season,
            date_submitted=dt,
            conf_id=0,
            division_id=1,
            rank=2,
            team_id=afc_east_second,
            pick_type=1,
        )
        session.add(afc_east_second_db)

        afc_east_last_db = PlayerPicks(
            user_id=user_id,
            season=season,
            date_submitted=dt,
            conf_id=0,
            division_id=1,
            rank=4,
            team_id=afc_east_last,
            pick_type=1,
        )

        session.add(afc_east_last_db)

        afc_north_winner_db = PlayerPicks(
            user_id=user_id,
            season=season,
            date_submitted=dt,
            conf_id=0,
            division_id=2,
            rank=1,
            team_id=afc_north_winner_pick,
            pick_type=1,
        )
        session.add(afc_north_winner_db)
        afc_north_second_db = PlayerPicks(
            user_id=user_id,
            season=season,
            date_submitted=dt,
            conf_id=0,
            division_id=2,
            rank=2,
            team_id=afc_north_second,
            pick_type=1,
        )
        session.add(afc_north_second_db)

        afc_north_last_db = PlayerPicks(
            user_id=user_id,
            season=season,
            date_submitted=dt,
            conf_id=0,
            division_id=2,
            rank=4,
            team_id=afc_north_last,
            pick_type=1,
        )

        session.add(afc_north_last_db)

        afc_south_winner_db = PlayerPicks(
            user_id=user_id,
            season=season,
            date_submitted=dt,
            conf_id=0,
            division_id=3,
            rank=1,
            team_id=afc_south_winner_pick,
            pick_type=1,
        )
        session.add(afc_south_winner_db)
        afc_south_second_db = PlayerPicks(
            user_id=user_id,
            season=season,
            date_submitted=dt,
            conf_id=0,
            division_id=3,
            rank=2,
            team_id=afc_south_second,
            pick_type=1,
        )
        session.add(afc_south_second_db)

        afc_south_last_db = PlayerPicks(
            user_id=user_id,
            season=season,
            date_submitted=dt,
            conf_id=0,
            division_id=3,
            rank=4,
            team_id=afc_south_last,
            pick_type=1,
        )

        session.add(afc_south_last_db)

        afc_west_winner_db = PlayerPicks(
            user_id=user_id,
            season=season,
            date_submitted=dt,
            conf_id=0,
            division_id=4,
            rank=1,
            team_id=afc_west_winner_pick,
            pick_type=1,
        )
        session.add(afc_west_winner_db)
        afc_west_second_db = PlayerPicks(
            user_id=user_id,
            season=season,
            date_submitted=dt,
            conf_id=0,
            division_id=4,
            rank=2,
            team_id=afc_west_second,
            pick_type=1,
        )
        session.add(afc_west_second_db)

        afc_west_last_db = PlayerPicks(
            user_id=user_id,
            season=season,
            date_submitted=dt,
            conf_id=0,
        ...
        # Add AFC team picks
        nfc_east_winner_db = PlayerPicks(
            user_id=user_id,
            season=season,
            date_submitted=dt,
            conf_id=1,
            division_id=1,
            rank=1,
            team_id=nfc_east_winner_pick,
            pick_type=1,
        )
        session.add(nfc_east_winner_db)
        nfc_east_second_db = PlayerPicks(
            user_id=user_id,
            season=season,
            date_submitted=dt,
            conf_id=1,
            division_id=1,
            rank=2,
            team_id=nfc_east_second,
            pick_type=1,
        )
        session.add(nfc_east_second_db)

        nfc_east_last_db = PlayerPicks(
            user_id=user_id,
            season=season,
            date_submitted=dt,
            conf_id=1,
            division_id=1,
            rank=4,
            team_id=nfc_east_last,
            pick_type=1,
        )

        session.add(nfc_east_last_db)

        nfc_north_winner_db = PlayerPicks(
            user_id=user_id,
            season=season,
            date_submitted=dt,
            conf_id=1,
            division_id=2,
            rank=1,
            team_id=nfc_north_winner_pick,
            pick_type=1,
        )
        session.add(nfc_north_winner_db)
        nfc_north_second_db = PlayerPicks(
            user_id=user_id,
            season=season,
            date_submitted=dt,
            conf_id=1,
            division_id=2,
            rank=2,
            team_id=nfc_north_second,
            pick_type=1,
        )
        session.add(nfc_north_second_db)

        nfc_north_last_db = PlayerPicks(
            user_id=user_id,
            season=season,
            date_submitted=dt,
            conf_id=1,
            division_id=2,
            rank=4,
            team_id=nfc_north_last,
            pick_type=1,
        )

        session.add(nfc_north_last_db)

        nfc_south_winner_db = PlayerPicks(
            user_id=user_id,
            season=season,
            date_submitted=dt,
            conf_id=1,
            division_id=3,
            rank=1,
            team_id=nfc_south_winner_pick,
            pick_type=1,
        )
        session.add(nfc_south_winner_db)
        nfc_south_second_db = PlayerPicks(
            user_id=user_id,
            season=season,
            date_submitted=dt,
            conf_id=1,
            division_id=3,
            rank=2,
            team_id=nfc_south_second,
            pick_type=1,
        )
        session.add(nfc_south_second_db)

        nfc_south_last_db = PlayerPicks(
            user_id=user_id,
            season=season,
            date_submitted=dt,
            conf_id=1,
            division_id=3,
            rank=4,
            team_id=nfc_south_last,
            pick_type=1,
        )

        session.add(nfc_south_last_db)

        nfc_west_winner_db = PlayerPicks(
            user_id=user_id,
            season=season,
            date_submitted=dt,
            conf_id=1,
            division_id=4,
            rank=1,
            team_id=nfc_west_winner_pick,
            pick_type=1,
        )
        session.add(nfc_west_winner_db)
        nfc_west_second_db = PlayerPicks(
            user_id=user_id,
            season=season,
            date_submitted=dt,
            conf_id=1,
            division_id=4,
            rank=2,
            team_id=nfc_west_second,
            pick_type=1,
        )
        session.add(nfc_west_second_db)

        nfc_west_last_db = PlayerPicks(
            user_id=user_id,
            season=season,
            date_submitted=dt,
            conf_id=1,
        ...
        afc_passing_db = PlayerPicks(
            user_id=user_id,
            season=season,
            date_submitted=dt,
            player_id=afc_qb_pick,
            pick_type=4,
            conf_id=0,
        )
        session.add(afc_passing_db)

        afc_rushing_db = PlayerPicks(
            user_id=user_id,
            season=season,
            date_submitted=dt,
            player_id=afc_rb_pick,
            pick_type=5,
            conf_id=0,
        )
        session.add(afc_rushing_db)

        afc_receiving_db = PlayerPicks(
            user_id=user_id,
            season=season,
            date_submitted=dt,
            player_id=afc_rec_pick,
            pick_type=6,
            conf_id=0,
        )
        session.add(afc_receiving_db)

        afc_sacks_db = PlayerPicks(
            user_id=user_id,
            season=season,
            date_submitted=dt,
            player_id=afc_sacks_pick,
            pick_type=7,
            conf_id=0,
        )
        session.add(afc_sacks_db)

        afc_int_db = PlayerPicks(
            user_id=user_id,
            season=season,
            date_submitted=dt,
            player_id=afc_int_pick,
            pick_type=8,
            conf_id=0,
        )
        ...
        nfc_passing_db = PlayerPicks(
            user_id=user_id,
            season=season,
            date_submitted=dt,
            player_id=nfc_qb_pick,
            pick_type=4,
            conf_id=1,
        )
        session.add(nfc_passing_db)

        nfc_rushing_db = PlayerPicks(
            user_id=user_id,
            season=season,
            date_submitted=dt,
            player_id=nfc_rb_pick,
            pick_type=5,
            conf_id=1,
        )
        session.add(nfc_rushing_db)

        nfc_receiving_db = PlayerPicks(
            user_id=user_id,
            season=season,
            date_submitted=dt,
            player_id=nfc_rec_pick,
            pick_type=6,
            conf_id=1,
        )
        session.add(nfc_receiving_db)

        nfc_sacks_db = PlayerPicks(
            user_id=user_id,
            season=season,
            date_submitted=dt,
            player_id=nfc_sacks_pick,
            pick_type=7,
            conf_id=1,
        )
        session.add(nfc_sacks_db)

        nfc_int_db = PlayerPicks(
            user_id=user_id,
            season=season,
            date_submitted=dt,
            player_id=nfc_int_pick,
            pick_type=8,
            conf_id=1,
        )
        ...
        afc_wildcard1_db = PlayerPicks(
            user_id=user_id,
            season=season,
            date_submitted=dt,
            team_id=afc_wildcard1_pick,
            pick_type=9,
            conf_id=0,
            rank=1,
        )
        ...
        afc_wildcard2_db = PlayerPicks(
            user_id=user_id,
            season=season,
            date_submitted=dt,
            team_id=afc_wildcard2_pick,
            pick_type=9,
            conf_id=0,
            rank=2,
        )
        ...
        nfc_wildcard1_db = PlayerPicks(
            user_id=user_id,
            season=season,
            date_submitted=dt,
            team_id=nfc_wildcard1_pick,
            pick_type=9,
            conf_id=1,
            rank=1,
        )
        ...
        nfc_wildcard2_db = PlayerPicks(
            user_id=user_id,
            season=season,
            date_submitted=dt,
            team_id=nfc_wildcard2_pick,
            pick_type=9,
            conf_id=1,
            rank=2,
        )
        ...
        # Add the tiebreaker
        specialteams_tiebreaker_db = PlayerPicks(
            user_id=user_id,
            season=season,
            date_submitted=dt,
            team_id=specialteams_td_pick,
            pick_type=10,
        )
    ...
    def change_player_picks(
        ...
        for pick in (
            ...
            if pick != int(afc_east_winner_pick):
                session.query(PlayerPicks).filter(
                    ...
                    PlayerPicks.conf_id == 0
                ).filter(
                    PlayerPicks.division_id == 1
                ).filter(
                    PlayerPicks.season == season
                ).update(
                    {"team_id": afc_east_winner_pick, "date_submitted": now_time}
                )
        ...
        for pick in (
            ...
            if pick != int(afc_east_second):
                session.query(PlayerPicks).filter(
                    ...
                    {"team_id": afc_east_second, "date_submitted": now_time}
                )
        ...
        for pick in (
            ...
            if pick != int(afc_east_last):
                session.query(PlayerPicks).filter(
                    ...
                    {"team_id": afc_east_last, "date_submitted": now_time}
                )
        ...
        for pick in (
            ...
            if pick != int(afc_north_winner_pick):
                session.query(PlayerPicks).filter(
                    PlayerPicks.user_id == user_id
                ).filter(PlayerPicks.season == season).filter(
                    PlayerPicks.pick_type == 1
                    ...
                    {"team_id": afc_north_winner_pick, "date_submitted": now_time}
                )
        ...
        for pick in (
            ...
            if pick != int(afc_north_second):
                session.query(PlayerPicks).filter(
                    ...
                    {"team_id": afc_north_second, "date_submitted": now_time}
                )
        ...
        for pick in (
            ...
            if pick != int(afc_north_last):
                session.query(PlayerPicks).filter(
                    ...
                    {"team_id": afc_north_last, "date_submitted": now_time}
                )
        ...
        for pick in (
            ...
            if pick != int(afc_south_winner_pick):
                session.query(PlayerPicks).filter(
                    PlayerPicks.user_id == user_id
                ).filter(PlayerPicks.season == season).filter(
                    PlayerPicks.pick_type == 1
                    ...
                    {"team_id": afc_south_winner_pick, "date_submitted": now_time}
                )
        ...
        for pick in (
            ...
            if pick != int(afc_south_second):
                session.query(PlayerPicks).filter(
                    ...
                    {"team_id": afc_south_second, "date_submitted": now_time}
                )
        ...
        for pick in (
            ...
            if pick != int(afc_south_last):
                session.query(PlayerPicks).filter(
                    ...
                    {"team_id": afc_south_last, "date_submitted": now_time}
                )
        ...
        for pick in (
            ...
            if pick != int(afc_west_winner_pick):
                session.query(PlayerPicks).filter(
                    PlayerPicks.user_id == user_id
                ).filter(PlayerPicks.season == season).filter(
                    PlayerPicks.pick_type == 1
                    ...
                    PlayerPicks.division_id == 4
                ).filter(
                    PlayerPicks.season == season
                ).update(
                    {"team_id": afc_west_winner_pick, "date_submitted": now_time}
                )
        ...
        for pick in (
            ...
            if pick != int(afc_west_second):
                session.query(PlayerPicks).filter(
                    ...
                    {"team_id": afc_west_second, "date_submitted": now_time}
                )
        ...
        for pick in (
            ...
            if pick != int(afc_west_last):
                session.query(PlayerPicks).filter(
                    ...
                    {"team_id": afc_west_last, "date_submitted": now_time}
                )
        ...
        for pick in (
            ...
            if pick != int(nfc_east_winner_pick):
                session.query(PlayerPicks).filter(
                    PlayerPicks.user_id == user_id
                ).filter(PlayerPicks.season == season).filter(
                    PlayerPicks.pick_type == 1
                    ...
                    PlayerPicks.conf_id == 1
                ).filter(
                    PlayerPicks.division_id == 1
                ).filter(
                    PlayerPicks.season == season
                ).update(
                    {"team_id": nfc_east_winner_pick, "date_submitted": now_time}
                )
        ...
        for pick in (
            ...
            if pick != int(nfc_east_second):
                session.query(PlayerPicks).filter(
                    ...
                    {"team_id": nfc_east_second, "date_submitted": now_time}
                )
        ...
        for pick in (
            ...
            if pick != int(nfc_east_last):
                session.query(PlayerPicks).filter(
                    ...
                    {"team_id": nfc_east_last, "date_submitted": now_time}
                )
        ...
        for pick in (
            ...
            if pick != int(nfc_north_winner_pick):
                session.query(PlayerPicks).filter(
                    PlayerPicks.user_id == user_id
                ).filter(PlayerPicks.season == season).filter(
                    PlayerPicks.pick_type == 1
                    ...
                    {"team_id": nfc_north_winner_pick, "date_submitted": now_time}
                )
        ...
        for pick in (
            ...
            if pick != int(nfc_north_second):
                session.query(PlayerPicks).filter(
                    ...
                    {"team_id": nfc_north_second, "date_submitted": now_time}
                )
        ...
        for pick in (
            ...
            if pick != int(nfc_north_last):
                session.query(PlayerPicks).filter(
                    ...
                    {"team_id": nfc_north_last, "date_submitted": now_time}
                )
        ...
        for pick in (
            ...
            if pick != int(nfc_south_winner_pick):
                session.query(PlayerPicks).filter(
                    PlayerPicks.user_id == user_id
                ).filter(PlayerPicks.season == season).filter(
                    PlayerPicks.pick_type == 1
                    ...
                    {"team_id": nfc_south_winner_pick, "date_submitted": now_time}
                )
        ...
        for pick in (
            ...
            if pick != int(nfc_south_second):
                session.query(PlayerPicks).filter(
                    ...
                    {"team_id": nfc_south_second, "date_submitted": now_time}
                )
        ...
        for pick in (
            ...
            if pick != int(nfc_south_last):
                session.query(PlayerPicks).filter(
                    ...
                    {"team_id": nfc_south_last, "date_submitted": now_time}
                )
        ...
        for pick in (
            ...
            if pick != int(nfc_west_winner_pick):
                session.query(PlayerPicks).filter(
                    PlayerPicks.user_id == user_id
                ).filter(PlayerPicks.season == season).filter(
                    PlayerPicks.pick_type == 1
                    ...
                    {"team_id": nfc_west_winner_pick, "date_submitted": now_time}
                )
        ...
        for pick in (
            ...
            if pick != int(nfc_west_second):
                session.query(PlayerPicks).filter(
                    ...
                    {"team_id": nfc_west_second, "date_submitted": now_time}
                )
        ...
        for pick in (
            ...
            if pick != int(nfc_west_last):
                session.query(PlayerPicks).filter(
                    ...
                    {"team_id": nfc_west_last, "date_submitted": now_time}
                )
        ...
        for pick in (
            ...
            if pick != int(afc_pf_pick):
                session.query(PlayerPicks).filter(
                    ...
                    {"team_id": afc_pf_pick, "date_submitted": now_time}
                )
        ...
        for pick in (
            ...
            if int(pick) != int(nfc_pf_pick):
                session.query(PlayerPicks).filter(
                    ...
                    {"team_id": nfc_pf_pick, "date_submitted": now_time}
                )
        ...
        for pick in (
            ...
            if pick != int(afc_qb_pick):
                session.query(PlayerPicks).filter(
                    ...
                    {"player_id": afc_qb_pick, "date_submitted": now_time}
                )
        ...
        for pick in (
            ...
            if pick != int(nfc_qb_pick):
                session.query(PlayerPicks).filter(
                    ...
                    {"player_id": nfc_qb_pick, "date_submitted": now_time}
                )
        ...
        for pick in (
            ...
            if pick != int(afc_rb_pick):
                session.query(PlayerPicks).filter(
                    ...
                    {"player_id": afc_rb_pick, "date_submitted": now_time}
                )
        ...
        for pick in (
            ...
            if pick != int(nfc_rb_pick):
                session.query(PlayerPicks).filter(
                    ...
                    {"player_id": nfc_rb_pick, "date_submitted": now_time}
                )
        ...
        for pick in (
            ...
            if pick != int(afc_rec_pick):
                session.query(PlayerPicks).filter(
                    ...
                    {"player_id": afc_rec_pick, "date_submitted": now_time}
                )
        ...
        for pick in (
            ...
            if pick != int(nfc_rec_pick):
                session.query(PlayerPicks).filter(
                    ...
                    {"player_id": nfc_rec_pick, "date_submitted": now_time}
                )
        ...
        for pick in (
            ...
            if pick != int(afc_sacks_pick):
                session.query(PlayerPicks).filter(
                    ...
                    {"player_id": afc_sacks_pick, "date_submitted": now_time}
                )
        ...
        for pick in (
            ...
            if pick != int(nfc_sacks_pick):
                session.query(PlayerPicks).filter(
                    ...
                    {"player_id": nfc_sacks_pick, "date_submitted": now_time}
                )
        ...
        for pick in (
            ...
            if pick != int(afc_int_pick):
                session.query(PlayerPicks).filter(
                    ...
                    {"player_id": afc_int_pick, "date_submitted": now_time}
                )
        ...
        for pick in (
            ...
            if pick != int(nfc_int_pick):
                session.query(PlayerPicks).filter(
                    ...
                    {"player_id": nfc_int_pick, "date_submitted": now_time}
                )
        ...
        for pick in (
            ...
            if pick != int(afc_wildcard1_pick):
                session.query(PlayerPicks).filter(
                    ...
                    {"team_id": afc_wildcard1_pick, "date_submitted": now_time}
                )
        ...
        for pick in (
            ...
            if pick != int(afc_wildcard2_pick):
                session.query(PlayerPicks).filter(
                    PlayerPicks.user_id == user_id
                ).filter(PlayerPicks.season == season).filter(
                    PlayerPicks.pick_type == 9
                    ...
                    {"team_id": afc_wildcard2_pick, "date_submitted": now_time}
                )
        ...
        for pick in (
            ...
            if pick != int(nfc_wildcard1_pick):
                session.query(PlayerPicks).filter(
                    PlayerPicks.user_id == user_id
                ).filter(PlayerPicks.season == season).filter(
                    PlayerPicks.pick_type == 9
                    ...
                    {"team_id": nfc_wildcard1_pick, "date_submitted": now_time}
                )
        ...
        for pick in (
            ...
            if pick != int(nfc_wildcard2_pick):
                session.query(PlayerPicks).filter(
                    PlayerPicks.user_id == user_id
                ).filter(PlayerPicks.season == season).filter(
                    PlayerPicks.pick_type == 9
                    ...
                    {"team_id": nfc_wildcard2_pick, "date_submitted": now_time}
                )
        ...
        for pick in (
            ...
            if pick != int(specialteams_td_pick):
                session.query(PlayerPicks).filter(
                    ...
                    PlayerPicks.pick_type == 10
                ).update(
                    {"team_id": specialteams_td_pick, "date_submitted": now_time}
                )
...
class DisplayPlayerPicks:
    ...
    def display_picks(user_id):
        ...
        user_query = (
            session.query(PlayerPicks, TeamInfo.name)
